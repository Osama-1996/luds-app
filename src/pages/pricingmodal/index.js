        ...
        <div className="bg-black  p-8 text-white">
            <div className="px-[80px] pt-6">
                ...
                <div className="pt-12 pb-8">
                    <h2 className="text-2xl xl:text-3xl lg:text-3xl md:text-2xl sm:text-xl xs:text-xl font-bold mb-5">
                        Unbeatable Pricing
                    </h2>
                    <p className="mb-5  text-[27px] xl:text-[30px] font-[500]">
                    ...
                    <p className=" mb-5 text-[33px] xl:text-[36px] font-[600]">
                        We guarantee Top Dollar talent in Bottom Dollar price!
                    </p>
                    <p className="mb-6 text-[27px] xl:text-[30px] font-[500]">
                        ...
                        <div className="bg-[#393939] p-1 rounded-full inline-flex">
                            {tabs.map((tab, index) => (
                                <button
                                    ...
                                    className={`px-9 py-5  rounded-full font-semibold ${activeTab === index ? 'bg-gradient-to-r from-[#911A57] to-[#3D155F]' : ''}`}
                                >
                                    {tab.title}
                                </button>
                            ))}
